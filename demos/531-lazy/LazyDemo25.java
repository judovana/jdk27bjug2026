...
public class LazyDemo25 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // ------------------------
        // Access StableValue constants
        // ------------------------
        start = System.nanoTime();
        long value1 = Lazy.V1.orElseSet(() -> Heavy.compute(1));
        long value2 = Lazy.V2.orElseSet(() -> Heavy.compute(2));
        long value3 = Lazy.V3.orElseSet(() -> Heavy.compute(3));
//        long value4 = Lazy.V4.orElseSet(() -> Heavy.compute(4));
//        long value5 = Lazy.V5.orElseSet(() -> Heavy.compute(5));
//        long value6 = Lazy.V6.orElseSet(() -> Heavy.compute(6));
//        long value7 = Lazy.V7.orElseSet(() -> Heavy.compute(7));
//        long value8 = Lazy.V8.orElseSet(() -> Heavy.compute(8));
//        long value9 = Lazy.V9.orElseSet(() -> Heavy.compute(9));
//        long value10 = Lazy.V10.orElseSet(() -> Heavy.compute(10));
        end = System.nanoTime();
        System.out.println("StableValues access (N constants): " + (end - start)/1_000_000 + " ms");
...
class Lazy {
    ...
    static final StableValue<Long> V1  = StableValue.of();
    static final StableValue<Long> V2  = StableValue.of();
    static final StableValue<Long> V3  = StableValue.of();
    static final StableValue<Long> V4  = StableValue.of();
    static final StableValue<Long> V5  = StableValue.of();
    static final StableValue<Long> V6  = StableValue.of();
    static final StableValue<Long> V7  = StableValue.of();
    static final StableValue<Long> V8  = StableValue.of();
    static final StableValue<Long> V9  = StableValue.of();
    static final StableValue<Long> V10 = StableValue.of();
}
